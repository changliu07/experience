...
Site = 'https://wwwx.cs.unc.edu/Courses/comp116-001-f16/'
def Failsafe():
    global Site
    Site = 'https://gbserver3.cs.unc.edu:10443/'
...
try:
    ...
    def start(assignment):
        ...
        expected.update(pickle.load(open(assignment + '.pickle', 'rb')))
        return check, report
    ...
    def report(author, extra):
        ...
        print("  {} of {} correct, {} of {} points".format(correct, problems, points, max_points))
...
def describe_answer(o):
    ...
    desc = re.sub(r'(\d+) (\(?)(tuple|list|dictionary|integer|float|boolean|plot)', pluralize, desc)
    return desc
